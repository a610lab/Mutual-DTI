...
#     dir_input = ('../dataset/' + DATASET + '/input/for_train13/')
    ...
    # seed = 1234
        ...
        """Output files."""
        path = 'nofull_model_output/'+DATASET+'/'+str(seed)+'/'
        ...
        max_AUC_dev = 0
        epoch_label = 0
        AUCdev = ('Epoch\ttime\tloss_train\tAUC_dev\tPrecision_dev\tRecall_dev\tAccuracy_dev')
        print(AUCdev)
        ...
        for epoch in range(1, iteration+1):
            ...
            AUC_dev, precision_dev, recall_dev, Accuracy_dev = dever.test(dataset_dev)
            # AUC_test, precision_test, recall_test, Accuracy_test = tester.test(dataset_dev)
            end = timeit.default_timer()
            time = end - start
            standard = [epoch, time, loss_train, AUC_dev,
                    precision_dev, recall_dev, Accuracy_dev]
